...
elNavbar.innerHTML = `
  <div class="container">
    ...
    <div class="navbar-left">
      ...
      <img class="logo-dark" src="../assets/img/apple-touch-icon.png" height="auto" width="70vw" alt="logo">
      <img class="logo-light" src="../assets/img/apple-touch-icon.png" height="auto" width="70vw" alt="logo">
        </a>
    </div>
    ...
    <a class="d-none d-md-block btn btn-md bg-blue" href="#typeform">Request for free</a>
    <a class="d-block d-md-none btn btn-md bg-blue" href="#typeform">Request</a>
...
<div class="container">
  <div class="text-center row gap-y d-flex justify-content-center">
    ...
    <div class="d-none d-lg-block col-md-3 text-left align-self-center">
      <small>&copy; 2017-2019 GigLoft Inc.</small>
    </div>

      <div class="col-md-6">
        <img class="" src="../assets/img/apple-touch-icon.png" height="auto" width="70vw" alt="logo">
